...
caminhodopdfP = f"C:/Users/richa/Desktop/Programação/Josenalde/Febrace/2020/Premiados/Premiados2020.pdf"
...
nomedodatabase = 'Database_Febrace'
nomedacolecao = 'tabela_premiados'
...
for contagem in range(len(linhas)):
    ...
    cpremiacao = "Destaque em Ciências Comportamentais"
    nomeprojeto = ""
    escola = ""
    participantes = ""
    ...
    if "lugar" in linhas[contagem].lower():
        vartempo = linhas[contagem]
