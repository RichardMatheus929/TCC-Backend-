...
def orientador(nomeproj = ""):
    ...
    orientador = "Campo não encontrado";componentes = 0;linhaorientador = "Campo não encontrado"
    for paginas in range(len(textopag)):
        ...
        if resposta:
            ...
            for linha in range(len(paginaorientador)):
                ...
                if resposta:
                    paginaorientador.append("Linha alternativa");paginaorientador.append("Linha alternativa");paginaorientador.append("Linha alternativa");paginaorientador.append("Linha alternativa")
